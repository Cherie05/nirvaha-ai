    ...
    <section id="how" className="relative w-full overflow-hidden">
      <div className="relative min-h-[700px]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8 py-24">
          <h2 className="text-center text-[clamp(2rem,5vw,5rem)] font-black leading-[1.0] tracking-tighter text-[#10b981] uppercase mb-4">
            HOW NIRVAHA WORKS
          </h2>

          <p className="text-center mb-16">
            <span className="font-mono-label text-black bg-[#10b981] px-4 py-2 inline-block">
          ...
          <div className="relative">
            {/* Center line */}
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] bg-[#10b981]/40 md:-translate-x-[1px]" />

            <div className="space-y-12">
              {STEPS.map((step, i) => (
                <div key={i} className="relative flex items-start">
                  {/* Dot on timeline */}
                  <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-[#10b981] border-2 border-black rounded-full -translate-x-1/2 mt-1 z-10" />

                  {/* Content card */}
                  <div className={`ml-16 md:ml-0 md:w-[45%] ${i % 2 === 0 ? 'md:pr-12' : 'md:ml-[55%] md:pl-12'}`}>
                    <span className="inline-block bg-[#10b981] text-black font-mono-label px-3 py-1 text-xs font-bold mb-3">
                      {step.label}
                    </span>
