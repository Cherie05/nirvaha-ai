...
export default function VcSection() {
  return (
    <section className="py-20 relative bg-gradient-to-b from-[#060e0a] to-[#040806] border-t border-emerald-950">
      <div className="mx-auto max-w-7xl px-6">
        <div className="glass-card rounded-3xl p-8 md:p-12 relative overflow-hidden border-emerald-500/30">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  ...
                  className="flex items-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 text-xs font-bold text-black hover:bg-emerald-400 shadow-lg shadow-emerald-500/20"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-900 px-5 py-3 text-xs font-bold text-slate-200 hover:bg-slate-800"
                >
