  ...
  return (
    <section id="demo" className="bg-[#e8e4df] py-24 px-8 border-t border-neutral-400">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-6">
              Real-time map routing, neighborhood zone claiming, WebSocket aggregation feed. React 18 + Leaflet + Socket.io.
            </p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block bg-[#10b981] text-black p-8 hover:bg-[#34d399] transition-colors group"
          >
            <div className="flex justify-between items-start mb-8">
            ...
            <p className="text-black/70 text-sm leading-relaxed mb-6">
              Flutter app with multimodal AI vision. Scan any plastic item, get resin code, weight estimate, and sorting advice in 2.2 seconds.
            </p>
        ...
        {/* API Health */}
        <div className="mt-6 bg-white border border-neutral-300 p-6 flex items-center justify-between">
          <div>
            <span className="font-mono-label text-neutral-500 text-xs">BACKEND API · RAILWAY</span>
            <p className="text-base font-bold mt-1">NestJS 10 + PostgreSQL + Redis + Gemini 3.1 Flash</p>
          </div>
          <a
